...
parser.add_argument('--tem', type=float, default=0.9, help='Sharpening temperature')
parser.add_argument('--lam', type=float, default=0.5, help='Lamda') # sample=1时，consis_loss相当于就sharp了一下
...
for i in trange(args.runs, desc='Run Train'):
    ...
    for epoch in range(args.epochs):
        ...
        loss_train = loss_train + args.lam * loss_consis  # + 0.1*model.contrasive_loss(gnn_emb1, gnn_emb2)#  + 0.5*model.contrasive_loss(sharp_emb1, gnn_emb2)1.2
    ...
    # UNF_mask = torch.load("./UNF_mask/" + args.dataset + "_UNF_mask"+str(i)+".pt")
